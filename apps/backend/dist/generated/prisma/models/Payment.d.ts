...
export type PaymentWhereInput = {
    ...
    pedidoId?: Prisma.StringFilter<"Payment"> | string;
    valor?: Prisma.DecimalFilter<"Payment"> | runtime.Decimal | runtime.DecimalJsLike | number | string;
    metodo?: Prisma.EnumPaymentMethodFilter<"Payment"> | $Enums.PaymentMethod;
    data?: Prisma.DateTimeFilter<"Payment"> | Date | string;
    status?: Prisma.EnumPaymentStatusFilter<"Payment"> | $Enums.PaymentStatus;
    observacao?: Prisma.StringNullableFilter<"Payment"> | string | null;
...
export type PaymentScalarWhereWithAggregatesInput = {
    ...
    pedidoId?: Prisma.StringWithAggregatesFilter<"Payment"> | string;
    valor?: Prisma.DecimalWithAggregatesFilter<"Payment"> | runtime.Decimal | runtime.DecimalJsLike | number | string;
    metodo?: Prisma.EnumPaymentMethodWithAggregatesFilter<"Payment"> | $Enums.PaymentMethod;
    data?: Prisma.DateTimeWithAggregatesFilter<"Payment"> | Date | string;
    status?: Prisma.EnumPaymentStatusWithAggregatesFilter<"Payment"> | $Enums.PaymentStatus;
    observacao?: Prisma.StringNullableWithAggregatesFilter<"Payment"> | string | null;
};
...
export type PaymentUpdateInput = {
    ...
    metodo?: Prisma.EnumPaymentMethodFieldUpdateOperationsInput | $Enums.PaymentMethod;
...
export type PaymentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "pedidoId" | "valor" | "metodo" | "data" | "status" | "observacao", ExtArgs["result"]["payment"]>;
...
export interface PaymentFieldRefs {
    ...
    readonly pedidoId: Prisma.FieldRef<"Payment", 'String'>;
    readonly valor: Prisma.FieldRef<"Payment", 'Decimal'>;
    readonly metodo: Prisma.FieldRef<"Payment", 'PaymentMethod'>;
    readonly data: Prisma.FieldRef<"Payment", 'DateTime'>;
    readonly status: Prisma.FieldRef<"Payment", 'PaymentStatus'>;
    readonly observacao: Prisma.FieldRef<"Payment", 'String'>;
}
