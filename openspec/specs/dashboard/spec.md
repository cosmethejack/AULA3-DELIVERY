...
O sistema DEVE (MUST) expor endpoint `GET /v1/dashboard/summary` com vendas do período, valores recebidos/pendentes e top 5 produtos.
...
Admin DEVE (MUST) poder registrar pagamento associado a um pedido via `POST /v1/orders/:id/payments`.
