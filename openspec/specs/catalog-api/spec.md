...
O sistema DEVE (MUST) expor endpoints REST para criar, listar, editar e remover categorias. Categorias inativas não são retornadas na listagem pública.
...
O sistema DEVE (MUST) expor endpoints REST para criar, listar, editar e remover produtos. Produtos inativos não aparecem na vitrine.
...
### Requirement: Remoção de categoria como desativação
