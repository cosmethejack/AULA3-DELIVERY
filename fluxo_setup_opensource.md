...
Os provedores a seguir possuem free tiers de modelos. Para alguns deles, é necessário adquirir créditos, para outros, não.
...
- Na lista apresentada, selecione seu modelo de preferência. Atente para selecionar modelos do provider Omniroute.
...
Para utilização de skills e outros recursos, o Opencode suporta as informações disponíveis no diretório `.agents`
